...
# The schema moved twice: implicitjs folded into cadjs, and skills stopped vendoring a
# copy of it. The skill now points at the one source of truth in the repo, which is what
# this test is really for.
SCHEMA_PATH_REFERENCE = "packages/cadjs/src/lib/implicitCad/schema.js"
...
class ImplicitCadSchemaReferenceTests(unittest.TestCase):
    ...
    def test_schema_path_reference_resolves(self) -> None:
        schema = repo_path(SCHEMA_PATH_REFERENCE)
