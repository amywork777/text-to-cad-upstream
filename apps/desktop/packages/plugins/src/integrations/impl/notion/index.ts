      ...
      methods: [
        {
          ...
          help: 'Create a Notion internal integration token or personal access token, then share each page or database you want Hardcore to access with that integration.',
