          ...
          const body = (
            <>
              ...
              <span className="flex min-w-0 flex-1 flex-col items-start gap-0.5">
                ...
                <span className="w-full truncate text-left text-tiny text-foreground-muted">
                  {stepDescription(step)}
                </span>
                {step.status === 'failed' && step.message ? (
                  <span className="w-full truncate text-left text-tiny text-foreground-destructive">
                    {step.message}
                  </span>
                ) : null}
                {step.status === 'cancelled' && step.message ? (
                  <span className="w-full truncate text-left text-tiny text-foreground-passive">
                    {step.message}
                  </span>
                ) : null}
              </span>
              ...
              >
                ...
                {step.status === 'failed' ? (
                  <button
                    ...
                    className="flex shrink-0 items-center gap-1 rounded-md border border-border px-1.5 py-0.5 text-tiny text-foreground-muted transition-colors hover:text-foreground disabled:opacity-60"
                  >
