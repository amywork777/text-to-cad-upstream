...
function ModalPlaceholder({ issueProvider }: IssueSelectorTriggerContext) {
  ...
  return (
    <span className="flex h-14 w-full items-center justify-center gap-2 rounded-lg p-2 text-sm text-foreground-passive transition-colors hover:bg-background-2">
  ...
  return (
    <IssueSelector
      ...
      renderSelectedValue={(issue) => (
        <div
          className={cn(
            'flex w-full items-center justify-between gap-2 overflow-hidden rounded-lg p-2 text-sm hover:bg-background-1 data-popup-open:bg-background-1',
