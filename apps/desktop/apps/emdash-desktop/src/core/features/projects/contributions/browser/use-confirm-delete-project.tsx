...
function deleteProjectDescription(projectLabel: string, automations: Automation[]) {
  if (automations.length === 0) {
    return `"${projectLabel}" will be removed from Hardcore. The project folder and model files will stay on the filesystem.`;
  }

  return (
    <div className="space-y-3">
      <p>
        {`"${projectLabel}" will be removed from Hardcore. The project folder and model files will stay on the filesystem.`}
      </p>
