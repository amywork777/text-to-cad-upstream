...
import type { AccountService } from './services/emdash-account-service';
...
async function getSession(service: AccountService, logger: Logger) {
...
async function signOut(service: AccountService, dependencies: AccountControllerDependencies) {
