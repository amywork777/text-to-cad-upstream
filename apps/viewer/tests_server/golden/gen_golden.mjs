...
//
// Writes two files:
//   tests_server/golden/golden.json  fixture for the Python encoder tests
...
const golden = {
  note: "GENERATED by tests_server/golden/gen_golden.mjs. Do not hand-edit.",
...
console.error(`wrote tests_server/golden/golden.json (${sortCorpusUnique.length} sort rows, ${sortPairs.length} pair signs)`);
