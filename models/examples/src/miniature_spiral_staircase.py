...
@step(out="../STEP/miniature_spiral_staircase.step")
@stl(out="../STL/miniature_spiral_staircase_highres.stl", mesh_tolerance=4e-4)
@threemf(out="../3MF/miniature_spiral_staircase_highres.3mf", mesh_tolerance=4e-4)
@glb(out="../GLB/miniature_spiral_staircase_highres.glb", mesh_tolerance=4e-4)
