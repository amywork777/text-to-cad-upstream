...
- `references/design-principles.md` — the three cadgen LAWS (generated-file
  independence, cache purity, decorator/function/CLI sync) with the
  pressure-test for each; read before changing generation, rendering,
  storage, or any public interface.
