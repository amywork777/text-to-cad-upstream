// "Does this definition ship animation clips?" — one question over whatever declared
// the clips, so the toolbar's Play button can ask it without knowing which store it is
// looking at.
