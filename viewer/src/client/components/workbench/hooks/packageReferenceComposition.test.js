...
import { parseSurf } from "cadjs/lib/surf/container.js";
import { tessellateComponent } from "cadjs/lib/surf/tessellate.js";
import { buildMeshDataFromSurf } from "cadjs/lib/surf/surfMeshData.js";
import { buildSelectorBundleFromSurf } from "cadjs/lib/surf/surfSelectorBundle.js";
import { buildGlbFaceIdsForPart, TOPOLOGY_FACE_ID_NONE } from "cadjs/lib/viewer/selectorPickGroups.js";
...
const FIXTURE = path.join(
  path.dirname(require.resolve("cadjs/lib/surf/container.js")),
  "fixtures",
  "sun_gear.surf"
);
